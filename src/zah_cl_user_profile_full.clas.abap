class ZAH_CL_USER_PROFILE_FULL definition
  public
...
public section.
  ...
  methods READ_ALL_METHODS
    ...
    exporting
      !EXP_USER_PA0001 type ZAH_TT_PERFIL_PA0001_FULL
      !EXP_USER_PA0002 type ZAH_TT_PERFIL_PA0002_FULL
      !EXP_USER_PA0006 type ZAH_TT_PERFIL_PA0006_FULL
      !EXP_USER_PA0009 type ZAH_TT_PERFIL_PA0009_FULL
      !EXP_USER_PA0016 type ZAH_TT_PERFIL_PA0016_FULL
      !EXP_USER_PA0021 type ZAH_TT_PERFIL_PA0021_FULL
      !EXP_USER_PA0105 type ZAH_TT_PERFIL_PA0105_FULL
      !EXP_USER_PA0185 type ZAH_TT_PERFIL_PA0185_FULL .
protected section.
private section.
  ...
  methods READ_INFTY_0001
    ...
    returning
      value(ZAH_S_PERFIL_PA0001) type ZAH_S_PERFIL_PA0001_FULL .
  methods READ_INFTY_0002
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0002) type ZAH_S_PERFIL_PA0002_FULL .
  methods READ_INFTY_0006
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0006) type ZAH_S_PERFIL_PA0006_FULL .
  methods READ_INFTY_0009
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0009) type ZAH_S_PERFIL_PA0009_FULL .
  methods READ_INFTY_0016
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0016) type ZAH_S_PERFIL_PA0016_FULL .
  methods READ_INFTY_0021
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0021) type ZAH_S_PERFIL_PA0021_FULL .
  methods READ_INFTY_0105
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0105) type ZAH_S_PERFIL_PA0105_FULL .
  methods READ_INFTY_0185
    importing
      !IT_NUM_EMP type ZAH_S_NUM_EMP
    returning
      value(ZAH_S_PERFIL_PA0185) type ZAH_S_PERFIL_PA0185_FULL .
ENDCLASS.



CLASS ZAH_CL_USER_PROFILE_FULL IMPLEMENTATION.
...
*    FREE: exp_perfil_colab.
    ...
    LOOP AT lt_num_emp INTO DATA(wa_num_col).
      ...
      DATA(ls_infty0001) = read_infty_0001( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0001

      DATA(ls_infty0002) = read_infty_0002( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0002

      DATA(ls_infty0006) = read_infty_0006( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0006

      DATA(ls_infty0009) = read_infty_0009( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0009

      DATA(ls_infty0016) = read_infty_0016( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0016

      DATA(ls_infty0021) = read_infty_0021( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0021

      DATA(ls_infty0105) = read_infty_0105( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0105

      DATA(ls_infty0185) = read_infty_0185( it_num_emp = wa_num_col ). "Leitura dos dados do infotipo 0185
...
*      MOVE-CORRESPONDING ls_infty0001 TO exp_user_pa0001.
*
*      MOVE-CORRESPONDING ls_infty0002 TO exp_user_pa0002.
*
*      MOVE-CORRESPONDING ls_infty0006 TO exp_user_pa0006.
*
*      MOVE-CORRESPONDING ls_infty0009 TO exp_user_pa0009.
**
*      MOVE-CORRESPONDING ls_infty0016 TO exp_user_pa0016.
**
*      MOVE-CORRESPONDING ls_infty0021 TO exp_user_pa0021.
**
*      MOVE-CORRESPONDING ls_infty0105 TO exp_user_pa0105.
**
*      MOVE-CORRESPONDING ls_infty0185 TO exp_user_pa0185.

      ls_infty0001-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0001 TO exp_user_pa0001.

      ls_infty0002-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0002 TO exp_user_pa0002.

      ls_infty0006-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0006 TO exp_user_pa0006.

      ls_infty0009-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0009 TO exp_user_pa0009.

      ls_infty0016-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0016 TO exp_user_pa0016.

      ls_infty0021-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0021 TO exp_user_pa0021.

      ls_infty0105-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0105 to exp_user_pa0105.

      ls_infty0185-num_colaborador = wa_num_col-num_emp.
      APPEND ls_infty0185 TO exp_user_pa0185.

*      APPEND wa_perfil_colab TO exp_perfil_colab. "Colocar a linha do colaborador para o parametro de exp.

      CLEAR: ls_infty0001, ls_infty0002, ls_infty0006, ls_infty0009,
       ls_infty0016, ls_infty0021,ls_infty0105, ls_infty0185.
  ...
  METHOD READ_INFTY_0001.
    ...
    READ TABLE gt_p0001 INTO DATA(wa_pa0001) WITH KEY pernr = it_num_emp.
...
*    zah_s_perfil_pa0105-num_colaborador = it_num_emp.

    LOOP AT gt_p0105 INTO DATA(wa_p0105) WHERE subty = '0010'.

      APPEND wa_p0105-usrid_long to zah_s_perfil_pa0105-email.

    ENDLOOP.

*    data: zah_s_perfil_pa0105 TYPE zah_s_perfil_pa0105_full.


*    zah_s_perfil_pa0105-email = wa_pa0105-usrid_long.

*    LOOP AT gt_p0105 INTO DATA(wa_pa0105) WHERE subty = '0010'.
*
*        APPEND wa_pa0105-usrid_long TO zah_s_perfil_pa0105-email.
*        APPEND zah_s_perfil_pa0105 to zah_tt_perfil_pa0105.
*
*    ENDLOOP.
